...
// You can make a class Public or leave it default or make it abstract or 
//final but you cannot make a class private or protected...
...
class ParentClass{
	...
	private int d = 40;//Within Parent class only , not even in the subclass
		void showData() {
		System.out.println("Himanshu Singh 2001173 H");
